...
| Contact  | Detail             |
| -------- | ------------------ |
| Address  | Nigeria, Rivers-State |
| Timezone | UTC/GMT +1              |
| E-mail   | onarigeorge013@gmail.com  |
...
If you want to find me on social media, just search for **@Onario747**. That's my username on almost all platforms, so it should be easy to find me.

But if you're short on time, I've included some links to the social media platforms I use most frequently below.

| Social Media | Profile URL                     |
| ------------ | ------------------------------- |
| Tiktok     | https://tiktok.com/@onariolovescoding |
| Twitter      | https://twitter.com/onario747     |
| Instagram    | https://instagram.com/onario747   |
